...
const SOCIALS = [
  { label: 'Facebook', icon: <FacebookIcon />, href: 'https://www.facebook.com/digitaldatadimensions/' },
      ...
      <div className="footer-inner">
        ...
        <div className="footer-bottom">
          <p style={{ fontSize: 12, color: '#6B7A8D' }}>
            © {new Date().getFullYear()} <strong style={{ color: '#002147', fontWeight: 400 }}>D3: Digital Data Dimensions.</strong> All rights reserved.
          </p>
