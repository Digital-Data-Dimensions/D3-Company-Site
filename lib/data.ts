...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    desc: 'TimeTech professional HRMS & Payroll for the Gulf Region — multi-company, multi-currency, bi-lingual, flexible and cost effective. Covers the complete employee lifecycle.',
