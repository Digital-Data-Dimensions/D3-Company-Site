...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const title = 'Client Case Studies & Outcomes | D3';
  const description = 'Completed client deployments and delivered outcomes — see how D3 solved real problems for government ministries, enterprises and institutions across Bahrain and the GCC.';
  return {
    ...
    openGraph: pageOpenGraph({ locale, path: '/case-studies', title, description }),
  };
}
